...
//            }
        ...
        <tr>
            ...
            <td>
                <button><a href="deleteres?id=<%= rs.getInt("id") %>" style="text-decoration: none">DELETE</a></button>
                <button><a href="updateres.jsp?id=<%= rs.getInt("id") %>" style="text-decoration: none">UPDATE</a></button>
            </td>
        </tr>
        <%
            }
