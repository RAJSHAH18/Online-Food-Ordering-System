...
//                }
                ...
                String res_nm=request.getParameter("name");
                int id=Integer.parseInt(request.getParameter("id"));
                String sql="UPDATE tbl_restaurant SET res_name=? WHERE id=?";
                ...
                if(x==1)
                {
                    out.println("<script>alert('Updated Successfully'); location.replace('viewrestaurant.jsp')</script>");
                }
            }
            catch(Exception e)
            {
